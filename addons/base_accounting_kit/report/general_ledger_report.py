...
class ReportGeneralLedger(models.AbstractModel):
    ...
    #         if not move_lines.get(account.id):
    #             move_lines[account.id].append({
    #                 'lid': 0,
    ...
    #             # running/final balance
    #             res['balance'] = line['balance']

    #         # final ending balance
    #         res['ending_balance'] = res['balance']
    ...
    def _get_account_move_entry(
        ...
        for account in accounts:
            ...
            if init_balance:
                ...
                # ALWAYS show initial balance row
                move_lines.append({
                    'ldate': '',
                    'lcode': '',
                    'partner_name': '',
